...
define Profile/GRWR001
	NAME:=GeekRouter GR-WR001
	PACKAGES:=kmod-usb-core kmod-usb2
endef


define Profile/GRWR001/Description
	Package set optimized for the GeekRouter GR-WR001.
endef
$(eval $(call Profile,GRWR001))
