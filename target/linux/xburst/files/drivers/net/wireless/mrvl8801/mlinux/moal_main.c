...
extern int mrvl_wlan_power_on();
#if 0
int mrvl_8801_wlan_init(void)
{
	int reset;
...
deferred_module_init(woal_init_module);
#elif defined(USE_LATE_INITCALL_SYNC)
late_initcall_sync(woal_init_module);
#else
late_initcall(woal_init_module);
