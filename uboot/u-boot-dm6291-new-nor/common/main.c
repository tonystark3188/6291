...
unsigned char wifi_mode_flag = 0;
...
#define WIFI_MODE_FLAG_ADDR		16715776 //ERASE_FLAG_ADDR+0x1000
...
int check_wifi_mode(void)
{
	printf("start check_wifi_mode\n");
	unsigned char wifi_mode_flag_tmp;
	//memset(wifi_mode_flag, 0, sizeof(wifi_mode_flag_buf));
	sfc_nor_read(WIFI_MODE_FLAG_ADDR, 1, &wifi_mode_flag_tmp);
	printf("wifi_mode_flag_buf :%d\r\n", wifi_mode_flag_tmp);
	if(wifi_mode_flag_tmp == 5)
	{
		wifi_mode_flag = 5;
	}
	else
