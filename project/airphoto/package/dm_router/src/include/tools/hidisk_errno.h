...
#define SQLITE_INTERNAL_ERR(x) ((x)!=0 && (x)<0xFFFF)
...
typedef enum ERROR_CODE
{
	...
	DM_ERROR_SERVER_EXCEPTION = 10101,/*服务器错误*/
	...
	ERROR_GET_CAMFILE= 10215,
	ERROR_GET_CAMTHUMB= 10216,
	ERROR_DEL_CAMFILE= 10217,
	ERROR_GET_CAMEXIF= 10218,
	ERROR_CAM_LISTFILE= 10219,
	ERROR_GET_CAMINFO= 10220,
	ERROR_GET_DETECT= 10221,
	ERROR_GET_LISTFILEBYPAGE= 10223,
	
	DM_ERROR_UCI = 10251,/*UCI 错误*/
	DM_ERROR_SHELL_HANDLE = 10253,/*脚本运行失败*/
	DM_ERROR_MCU_IOCTL_ERROR = 10254,/*MCU失败*/
	DM_ERROR_SOCKET_IOCTL_ERROR = 10255,/*网络通信失败*/

	DM_ERROR_DATABASE = 10212,/*数据库操作失败*/
	DM_ERROR_UNKNOW = 11000,/*未知错误*/

	DM_ERROR_DB_MKDIR = 12001,
	DM_ERROR_DB_RENAME = 12002,
