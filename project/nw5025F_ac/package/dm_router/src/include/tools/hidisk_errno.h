...
typedef enum ERROR_CODE
{
	...
	SERVER_MOVED_LOCATION = 10200,/*路径异常*/
    ...
    DM_ERROR_ENCRYPT_OPEN_FAIL = 13000,//open failed.
    DM_ERROR_ENCRYPT_SEEK_FAIL = 13001,//seek failed.
    DM_ERROR_ENCRYPT_SET_KEY_FAIL = 13002,//set encrypt key failed.
    DM_ERROR_ENCRYPT_WRITE_FAIL = 13003,//write encrypt file failed.
    DM_ERROR_ENCRYPT_SAVE_FAIL = 13004,//record failed, maybe already recorded.
    DM_ERROR_ENCRYPT_KEY_FAIL = 13005,//check encrypt key failed.
    DM_ERROR_DECRYPT_WRITE_FAIL = 13006,//decrypt write.
    DM_ERROR_DECRYPT_PAD_FAIL = 13007,//decrypt pad error.
    DM_ERROR_DECRYPT_READ_FAIL = 13008,//read failed.
    DM_ERROR_DECRYPT_KEY_FAIL = 13009,//check decrypt key failed.
    DM_ERROR_DECRYPT_OPEN_FAIL = 13010,//decrypt open failed.
    DM_ERROR_DECRYPT_DIR_FAIL = 13011,//decrypt dir open failed.
    DM_ERROR_VAULT_SET_PASSWD_FAIL = 13012,//SET VAULT PASSWORD FAILED.
    DM_ERROR_VAULT_SET_TIPS_FAIL = 13013,//SET VAULT TIPS FAILED.
    DM_ERROR_VAULT_GET_TOKEN_FAIL = 13014,//SET VAULT TOKEN FAILED.
    DM_ERROR_VAULT_SET_TOKEN_FAIL = 13015,//SET VAULT TOKEN FAILED.
    DM_ERROR_VAULT_TOKEN_ERROR = 13016,//VAULT CHECK TOKEN ERROR.
    DM_ERROR_VAULT_NOT_EMPTY = 13017,//VAULT IS NOT EMPTY.
    DM_ERROR_VAULT_EMPTY_ERROR = 13018,//SET VAULT EMPTY FAILED.
    DM_ERROR_VAULT_CHECK_PASSWD_FAIL = 13019,//VAULT CHECK PASSWORD FAILED.
    DM_ERROR_VAULT_GET_TIPS_FAIL = 13020,//VAULT GET TIPS FAILED.
}ERROR_CODE_T;	 
