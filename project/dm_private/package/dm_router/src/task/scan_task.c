...
//    memcpy(&p_msg->msg_data.db_obj.data.scan_data.mutex,&disk_info->mutex,sizeof(pthread_mutex_t));
...
//		 return enRet;
//	}
//    struct disk_node *m_disk_node = (struct disk_node *)malloc(sizeof(struct disk_node));
//    memcpy(m_disk_node,disk_info,sizeof(struct disk_node));
