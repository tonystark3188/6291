...
#define FN_GET_APList "APList"
	...
	#define APList_GET_ADD_NETWORK "Add_Network"
	#define APList_GET_ADD_NETWORK_name "name"
...
#define FN_GET_AddNetwork "AddNetwork"
...
#define FN_SET_OTAStatus "OTAStatus"
	#define SET_OTAStatus "status"

#define FN_SET_FsckTest "FsckTest"
	#define SET_FsckTest_reboot "reboot"
	#define SET_FsckTest_disk_power "disk_power"
	
#define FN_SET_RepairHandle "RepairHandle"
	#define SET_RepairHandle_mount_dir "mount_dir"

#define FN_SET_RepairAuto "RepairAuto"
	#define SET_RepairAuto_enable "enable"

#define FN_SET_ForgetWifiInfo "ForgetWifiInfo"
	#define SET_ForgetWifiInfo_BSSID  "mac"

#define FN_SET_DisabledClient "DisabledClient"
	#define FN_SET_DisabledClient_status  "disabled"
	  

#define FN_SET_SetDMClient   "SetDMClient"
	#define FN_SET_SetDMClient_Disabled "disabled"
