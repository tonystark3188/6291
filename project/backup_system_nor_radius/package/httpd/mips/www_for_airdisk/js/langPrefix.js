...
message.zh = {
    ...
    "upgrade": "固 件 升 级",
    "fw": "版本号:",
    "fwUpdateNotice":"设备处于备份系统状态，请使用手机APP或网页更新至最新固件！",
...
message.en = {
    ...
    "fw": "FW:",
    "fwUpdateNotice":"Device is in backup system, plesae use the cellphone APP or web page to update to the latest firmware!",
