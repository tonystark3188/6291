...
void system_reset(void)
{
	...
	set_reset_led_status(RESET_LED_BLINK);
	//system("echo timer > /sys/class/leds/longsys\:blue\:led/trigger ");
	//system("echo timer > /sys/class/leds/longsys\:green\:led/trigger ");
	//system("echo 100 > /sys/class/leds/longsys\:blue\:led/delay_on ");
	//system("echo 100 > /sys/class/leds/longsys\:blue\:led/delay_off ");
	//system("echo 100 > /sys/class/leds/longsys\:green\:led/delay_on ");
	//system("echo 100 > /sys/class/leds/longsys\:green\:led/delay_off ");
}
