...
int cfg_set(char *argv)
{
	...
	while(g_cfg_parameter[i])
	{
        ...
        {  
			...
			else if(!strncmp(argv,MODEL_NAME,strlen(MODEL_NAME))) //MODEL_NAME MODEL_NUMBER MODEL_DESCRIPTION MANUFACTURER
			{ 
				char set_nrender_str[128]="\0";
				memset(set_nrender_str,0,sizeof(set_nrender_str));
			...
			else if(!strncmp(argv,MODEL_NUMBER,strlen(MODEL_NUMBER))) //model_number
			{ 
				char set_nrender_str[128]="\0";
				memset(set_nrender_str,0,sizeof(set_nrender_str));
			...
			else if(!strncmp(argv,MODEL_DESCRIPTION,strlen(MODEL_DESCRIPTION))) //model_description
			{ 
				char set_nrender_str[128]="\0";
				memset(set_nrender_str,0,sizeof(set_nrender_str));
			...
			else if(!strncmp(argv,MANUFACTURER,strlen(MANUFACTURER))) //manufacturer
			{ 
				char set_nrender_str[128]="\0";
				memset(set_nrender_str,0,sizeof(set_nrender_str));
