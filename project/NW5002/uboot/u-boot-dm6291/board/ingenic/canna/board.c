...
#define LED_SYS    GPIO_PC(25)  /* for 5025F */
...
static void battery_init_gpio_poweron(void)
{
    gpio_port_direction_output(0, 0, 1);//GPIO_PA(0)--JJJHHH
    gpio_port_set_value(0, 0, 1);
	printf("-----set power port to 1------\n");
	
	gpio_port_direction_output(2, 25, 1);//GPIO_PC(25)--JJJHHH
	udelay(300000);
	gpio_port_set_value(2, 25, 0);
	udelay(300000);
	gpio_port_set_value(2, 25, 1);
	udelay(300000);
	gpio_port_set_value(2, 25, 0);
	udelay(300000);
	gpio_port_set_value(2, 25, 1);
