...
int handle_encrypt_file_delete_cmd(_In_ char *src_path,_In_ char *uuid);

int handle_encrypt_file_insert_cmd(_In_ char *file_uuid,_In_ char *src_path,_In_ char bIsRegularFile,_In_ char *uuid,_In_ char *encryptPath,_In_ long date,_In_ ssize_t encryFileSize);
