...
/*
 * I/O buffer descriptors
 */
struct io {
	unsigned char		*buf;		/* IO Buffer			*/
	//size_t		size;		/* IO buffer size		*/
	//size_t		head;		/* Bytes read			*/
	//size_t		tail;		/* Bytes written		*/
	//size_t		total;		/* Total bytes read		*/
	unsigned long long		size;		/* IO buffer size		*/
	unsigned long long		head;		/* Bytes read			*/
	unsigned long long		tail;		/* Bytes written		*/
	unsigned long long		total;		/* Total bytes read		*/
};
