...
#define WEBDAV_NAME			"webdav"
#define USB_DISK_NAME		"USB-disk-"
#define SD_DISK_NAME		"SD-disk-"
#define PRIVATE_DISK_NAME	"Private-disk-"
#define MOUNT_PATH			"/tmp/mnt"

#define HEADER_FILE 		"header.shtml"
#define FOOTER_FILE 		"footer.shtml"

#define DM_DB_FILE			"..airdisk.db"
#define DM_UUID_FILE		"..dmdiskuuid"

#define DISK_FILESYSTEM		0
#define FW_FILESYSTEM		1

#ifndef CONFIG
#define	CONFIG		"/usr/mips/conf/shttpd.conf"	/* Configuration file		*/
#endif /* CONFIG */
