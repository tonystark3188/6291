...
#define PTHREAD_JOIN(ID,RETVAL) thread_join(ID,RETVAL)
...
#define PTHREAD_RWLOCK_UNLOCK(EXCUTE) pthread_rwlock_unlock(EXCUTE)
#define PTHREAD_RWLOCK_TRYWRDLOCK(EXCUTE) pthread_rwlock_trywrdlock(EXCUTE)
#define PTHREAD_RWLOCK_TRYRDLOCK(EXCUTE)pthread_rwlock_tryrdlock(EXCUTE)
