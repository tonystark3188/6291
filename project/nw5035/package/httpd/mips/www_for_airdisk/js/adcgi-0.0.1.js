var api = {
    ...
    users: "<getSysInfo><Users/></getSysInfo>",
    network: "<getSysInfo><WorkMode/><Client/><RemoteAP/></getSysInfo>",
    joinwired: "<getSysInfo><JoinWired/></getSysInfo>",
    aplist: "<getSysInfo><APList/></getSysInfo>",
    remoteap: "<getSysInfo><RemoteAP/></getSysInfo>",
    ...
    g3:"<getSysInfo><G3/></getSysInfo>",
    wifiswitch:"<getSysInfo><wifiSwitch/></getSysInfo>",

	ota:"<getSysInfo><OTAStatus/></getSysInfo>",
	sysinfourl: "http://192.168.222.254/cgi-bin/getsysinfo",
    xunleiurl:"http://dynamic.i.xunlei.com/airdisk?from=$1&sysinfoIp=$2&sysinfoPort=$3&localIp=$4&localPort=$5&wap=$6&sign=$7",
    data: {
        from:"airdisk",
        sysinfoIp:"192.168.222.254",
        sysinfoPort:"80",
        localIp:"192.168.222.254",
        localPort:"9000",
        key:"lsn3b3*le3Djos8Inlel[eo:n~nNle"
    }
	
};

function adcgi_obj_ap(){
	 var ap = new Object; 
	 ap.name = "";
	 ap.encrypt = null;
	 ap.channel = null;
	 ...
	 ap.init = function(){
		 ap.name = "airdisk_001";
		 ap.encrypt = "WPA/WPA2-PSK";
		 ap.channel = 11;
		 ap.rssi = -85;
		 ap.tkip_aes = "tkip";
		 ap.mac = "ff:ff:ff:ff:ff:ff";	 	
	 }
	 return ap;
}
