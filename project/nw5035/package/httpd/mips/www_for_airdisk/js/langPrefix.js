...
message.zh = {
    ...
    "join": "加入网络",
    "wait": "请稍后...",
	"invalidPassword1": "为非法字符",
	"invalidPassword2": "密码含有非法字符，请重新填写密码",
    "tips": "请输入13个有效字符.",
    ...
    "notice": "提示:您需要先从点击浏览选择固件，再点击固件升级。",
	"noticeFileUpload":"文件正在上传...",
    "done": "完成",
    "back": "返回",
    "browse": "浏览",
    "availablefilealert":"无效的固件!",
	"availablefilealert1":"当前处于低电状态，不允许升级！",
...
message.en = {
	...
	"txtPasswordLength":"Please enter minimum 8 characters!",
	...
	"bindxunlei":"Xunlei Remote Downloading",
    ...
    "wait": "Please wait...",
	"invalidPassword1": "invalid character",
	"invalidPassword2": "Contains illegal characters. Please re-enter the password",
	...
	"noticeFileUpload":"Files are uploading...",
    "done": "Done",
    "back": "Back",
    "browse": "Browse",
    "availablefilealert":"Invalid firmware!",
	"availablefilealert1":"At present in a low state, the upgrade is not allowed!",
